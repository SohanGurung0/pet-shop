...
<nav class="navbar">
  <div class="nav-container">
    ...
    <ul class="nav-links">
      <li><a href="${pageContext.request.contextPath}/home" class="nav-link ${param.activeLink == 'home' ? 'nav-link--active' : ''}">Home</a></li>
      <li><a href="${pageContext.request.contextPath}/products" class="nav-link ${param.activeLink == 'shop' ? 'nav-link--active' : ''}">Shop All</a></li>
    ...
    <div class="nav-actions">
      <a href="${pageContext.request.contextPath}/cart" class="nav-cart ${param.activeLink == 'cart' ? 'nav-link--active' : ''}">
